let galleryImages = document.querySelectorAll(".img1, .img2, .img3, .img4, .img5, .img6");
...
let getImgUrlPos = getFullImgUrl.split("/images/gallery/");
...
newNextBtn.style.cssText = "right: 300px;";
...
newPrevBtn.style.cssText = "left: 300px;";
}
